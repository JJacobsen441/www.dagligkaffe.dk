...
namespace www.dagligkaffe.dk.Common
{
    ...
    {
        public string HandleError(TYPE type, ERROR function, Exception e)
        {
            string res = "Where: " + type.ToString() + " " + function.ToString() +
                         "<br />" + FormatError(e);
            return res;
        }
        ...
        /*public String HandleError_Arcade(ERROR_SHOPPINGAREA function, Exception e)
        {
            string res = "Exception: - " + function.ToString() + ", " + e.Message +
                        "<br /><br />InnerException: " + e.InnerException +
                        "<br /><br />StackTraceException: " + e.StackTrace;
            ...
            switch (function)
            {
                case ERROR_MARKETPLACE.MARKETPLACE:
                    res = "Exception: " + e.Message + " - Booth" +
                            "<br /><br />InnerException: " + e.InnerException +
                            "<br /><br />StackTraceException: " + e.StackTrace;
                    break;
                case ERROR_MARKETPLACE.BOOTH:
                    res = "Exception: " + e.Message + " - Booth" +
                            "<br /><br />InnerException: " + e.InnerException +
                            "<br /><br />StackTraceException: " + e.StackTrace;
                    break;
                case ERROR_MARKETPLACE.PRODUCT:
                    res = "Exception: " + e.Message + " - Booth" +
                            "<br /><br />InnerException: " + e.InnerException +
                            "<br /><br />StackTraceException: " + e.StackTrace;
                    break;                    
